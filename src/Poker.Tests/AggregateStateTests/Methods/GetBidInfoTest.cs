...
namespace Poker.Tests.AggregateStateTests.Methods
{
    ...
    public class GetBidInfoTest
    {
        ...
        {
            var bid = _state.GetBidInfo(1, 10);
            ...
            Assert.AreEqual(false, bid.AllIn);
        }
        ...
        public void IfNotEnoughtCash()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => _state.GetBidInfo(1, 10));
        }
        ...
        public void IfNoSuchPlayer()
        {
            ...
            Assert.Throws<KeyNotFoundException>(() => _state.GetBidInfo(1, 10));
        }
